...
/**
 * Criteria class for the {@link com.gsh.hris.domain.Department} entity. This class is used
 * in {@link com.gsh.hris.web.rest.DepartmentResource} to receive all the possible filtering options from
...
public class DepartmentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, employeeId, clusterId);
    }
