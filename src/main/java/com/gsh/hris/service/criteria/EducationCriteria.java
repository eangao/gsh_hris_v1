...
/**
 * Criteria class for the {@link com.gsh.hris.domain.Education} entity. This class is used
 * in {@link com.gsh.hris.web.rest.EducationResource} to receive all the possible filtering options from
...
public class EducationCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, bachelorDegree, yearGraduated, school, employeeId);
    }
