...
/**
 * Criteria class for the {@link com.gsh.hris.domain.Leave} entity. This class is used
 * in {@link com.gsh.hris.web.rest.LeaveResource} to receive all the possible filtering options from
...
public class LeaveCriteria implements Serializable, Criteria {
    ...
    private StringFilter physician;
    ...
    public LeaveCriteria(LeaveCriteria other) {
        ...
        this.physician = other.physician == null ? null : other.physician.copy();
    ...
    public StringFilter getPhysician() {
        return physician;
    }

    public StringFilter physician() {
        if (physician == null) {
            physician = new StringFilter();
        }
        return physician;
    }

    public void setPhysician(StringFilter physician) {
    ...
    public String toString() {
        return "LeaveCriteria{" +
            ...
            (physician != null ? "physician=" + physician + ", " : "") +
