...
import com.gsh.hris.service.ClusterQueryService;
...
/**
 * REST controller for managing {@link com.gsh.hris.domain.Cluster}.
 */
@RestController
@RequestMapping("/api")
public class ClusterResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/clusters/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<ClusterDTO> partialUpdateCluster(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, clusterDTO.getId().toString())
        );
    }
