...
import com.gsh.hris.service.DailyTimeRecordQueryService;
import com.gsh.hris.service.DailyTimeRecordService;
...
/**
 * REST controller for managing {@link com.gsh.hris.domain.DailyTimeRecord}.
 */
@RestController
@RequestMapping("/api")
public class DailyTimeRecordResource {
    ...
    public ResponseEntity<DailyTimeRecordDTO> createDailyTimeRecord(@RequestBody DailyTimeRecordDTO dailyTimeRecordDTO)
    ...
    public ResponseEntity<DailyTimeRecordDTO> updateDailyTimeRecord(
        ...
        @RequestBody DailyTimeRecordDTO dailyTimeRecordDTO
    ) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dailyTimeRecordDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/daily-time-records/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<DailyTimeRecordDTO> partialUpdateDailyTimeRecord(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dailyTimeRecordDTO.getId().toString())
        );
    }
