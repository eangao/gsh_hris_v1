...
import com.gsh.hris.service.DependentsQueryService;
import com.gsh.hris.service.DependentsService;
import com.gsh.hris.service.criteria.DependentsCriteria;
...
/**
 * REST controller for managing {@link com.gsh.hris.domain.Dependents}.
 */
@RestController
@RequestMapping("/api")
public class DependentsResource {
    ...
    public ResponseEntity<DependentsDTO> createDependents(@RequestBody DependentsDTO dependentsDTO) throws URISyntaxException {
    ...
    public ResponseEntity<DependentsDTO> updateDependents(
        ...
        @RequestBody DependentsDTO dependentsDTO
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dependentsDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/dependents/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<DependentsDTO> partialUpdateDependents(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dependentsDTO.getId().toString())
        );
    }
