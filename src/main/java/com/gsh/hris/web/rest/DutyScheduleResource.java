...
import com.gsh.hris.repository.DutyScheduleRepository;
import com.gsh.hris.service.DutyScheduleQueryService;
import com.gsh.hris.service.DutyScheduleService;
import com.gsh.hris.service.criteria.DutyScheduleCriteria;
...
/**
 * REST controller for managing {@link com.gsh.hris.domain.DutySchedule}.
 */
@RestController
@RequestMapping("/api")
public class DutyScheduleResource {
    ...
    public ResponseEntity<DutyScheduleDTO> createDutySchedule(@RequestBody DutyScheduleDTO dutyScheduleDTO) throws URISyntaxException {
    ...
    public ResponseEntity<DutyScheduleDTO> updateDutySchedule(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dutyScheduleDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/duty-schedules/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<DutyScheduleDTO> partialUpdateDutySchedule(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, dutyScheduleDTO.getId().toString())
        );
    }
