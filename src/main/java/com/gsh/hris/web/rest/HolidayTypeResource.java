...
import com.gsh.hris.repository.HolidayTypeRepository;
import com.gsh.hris.service.HolidayTypeQueryService;
import com.gsh.hris.service.HolidayTypeService;
import com.gsh.hris.service.criteria.HolidayTypeCriteria;
...
/**
 * REST controller for managing {@link com.gsh.hris.domain.HolidayType}.
 */
@RestController
@RequestMapping("/api")
public class HolidayTypeResource {
    ...
    public ResponseEntity<HolidayTypeDTO> createHolidayType(@RequestBody HolidayTypeDTO holidayTypeDTO) throws URISyntaxException {
    ...
    public ResponseEntity<HolidayTypeDTO> updateHolidayType(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, holidayTypeDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/holiday-types/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<HolidayTypeDTO> partialUpdateHolidayType(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, holidayTypeDTO.getId().toString())
        );
    }
