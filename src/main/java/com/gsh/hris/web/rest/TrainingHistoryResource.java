...
import com.gsh.hris.service.TrainingHistoryQueryService;
...
/**
 * REST controller for managing {@link com.gsh.hris.domain.TrainingHistory}.
 */
@RestController
@RequestMapping("/api")
public class TrainingHistoryResource {
    ...
    public ResponseEntity<TrainingHistoryDTO> createTrainingHistory(@RequestBody TrainingHistoryDTO trainingHistoryDTO)
    ...
    public ResponseEntity<TrainingHistoryDTO> updateTrainingHistory(
        ...
        @RequestBody TrainingHistoryDTO trainingHistoryDTO
    ) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, trainingHistoryDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/training-histories/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<TrainingHistoryDTO> partialUpdateTrainingHistory(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, trainingHistoryDTO.getId().toString())
        );
    }
