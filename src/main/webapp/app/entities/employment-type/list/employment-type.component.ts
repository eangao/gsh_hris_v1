...
export class EmploymentTypeComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.employmentTypeService
      ...
      .subscribe(
        (res: HttpResponse<IEmploymentType[]>) => {
  ...
  trackId(index: number, item: IEmploymentType): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IEmploymentType[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
