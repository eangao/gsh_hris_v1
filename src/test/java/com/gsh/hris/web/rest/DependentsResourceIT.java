...
class DependentsResourceIT {
    ...
    public static Dependents createEntity(EntityManager em) {
        Dependents dependents = new Dependents().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).relation(DEFAULT_RELATION);
        return dependents;
    }
    ...
    public static Dependents createUpdatedEntity(EntityManager em) {
        Dependents dependents = new Dependents().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).relation(UPDATED_RELATION);
        return dependents;
    }
    ...
    void putNewDependents() throws Exception {
        ...
        updatedDependents.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).relation(UPDATED_RELATION);
    ...
    void fullUpdateDependentsWithPatch() throws Exception {
        ...
        partialUpdatedDependents.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).relation(UPDATED_RELATION);
