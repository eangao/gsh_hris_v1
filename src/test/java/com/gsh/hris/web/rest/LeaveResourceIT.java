...
class LeaveResourceIT {
    ...
    private static final String DEFAULT_PHYSICIAN = "AAAAAAAAAA";
    private static final String UPDATED_PHYSICIAN = "BBBBBBBBBB";
    ...
    void createLeave() throws Exception {
        ...
        assertThat(testLeave.getPhysician()).isEqualTo(DEFAULT_PHYSICIAN);
    }
    ...
    @Test
    @Transactional
    void checkDateApplyIsRequired() throws Exception {
        int databaseSizeBeforeTest = leaveRepository.findAll().size();
        // set the field null
        leave.setDateApply(null);
    ...
    @Test
    @Transactional
    void checkDateReturnIsRequired() throws Exception {
        int databaseSizeBeforeTest = leaveRepository.findAll().size();
        // set the field null
        leave.setDateReturn(null);
    ...
    void getAllLeaves() throws Exception {
        ...
        restLeaveMockMvc
            ...
            .andExpect(jsonPath("$.[*].physician").value(hasItem(DEFAULT_PHYSICIAN)));
    }
    ...
    void getLeave() throws Exception {
        ...
        restLeaveMockMvc
            ...
            .andExpect(jsonPath("$.physician").value(DEFAULT_PHYSICIAN));
    }
    ...
    @Test
    @Transactional
    void getAllLeavesByPhysicianIsEqualToSomething() throws Exception {
        // Initialize the database
        leaveRepository.saveAndFlush(leave);

        // Get all the leaveList where physician equals to DEFAULT_PHYSICIAN
        defaultLeaveShouldBeFound("physician.equals=" + DEFAULT_PHYSICIAN);

        // Get all the leaveList where physician equals to UPDATED_PHYSICIAN
        defaultLeaveShouldNotBeFound("physician.equals=" + UPDATED_PHYSICIAN);
    }

    @Test
    @Transactional
    void getAllLeavesByPhysicianIsNotEqualToSomething() throws Exception {
        // Initialize the database
        leaveRepository.saveAndFlush(leave);

        // Get all the leaveList where physician not equals to DEFAULT_PHYSICIAN
        defaultLeaveShouldNotBeFound("physician.notEquals=" + DEFAULT_PHYSICIAN);

        // Get all the leaveList where physician not equals to UPDATED_PHYSICIAN
        defaultLeaveShouldBeFound("physician.notEquals=" + UPDATED_PHYSICIAN);
    }

    @Test
    @Transactional
    void getAllLeavesByPhysicianIsInShouldWork() throws Exception {
        // Initialize the database
        leaveRepository.saveAndFlush(leave);

        // Get all the leaveList where physician in DEFAULT_PHYSICIAN or UPDATED_PHYSICIAN
        defaultLeaveShouldBeFound("physician.in=" + DEFAULT_PHYSICIAN + "," + UPDATED_PHYSICIAN);

        // Get all the leaveList where physician equals to UPDATED_PHYSICIAN
        defaultLeaveShouldNotBeFound("physician.in=" + UPDATED_PHYSICIAN);
    }

    @Test
    @Transactional
    void getAllLeavesByPhysicianIsNullOrNotNull() throws Exception {
        // Initialize the database
        leaveRepository.saveAndFlush(leave);

        // Get all the leaveList where physician is not null
        defaultLeaveShouldBeFound("physician.specified=true");

        // Get all the leaveList where physician is null
        defaultLeaveShouldNotBeFound("physician.specified=false");
    }

    @Test
    @Transactional
    void getAllLeavesByPhysicianContainsSomething() throws Exception {
        // Initialize the database
        leaveRepository.saveAndFlush(leave);

        // Get all the leaveList where physician contains DEFAULT_PHYSICIAN
        defaultLeaveShouldBeFound("physician.contains=" + DEFAULT_PHYSICIAN);

        // Get all the leaveList where physician contains UPDATED_PHYSICIAN
        defaultLeaveShouldNotBeFound("physician.contains=" + UPDATED_PHYSICIAN);
    }

    @Test
    @Transactional
    void getAllLeavesByPhysicianNotContainsSomething() throws Exception {
        // Initialize the database
        leaveRepository.saveAndFlush(leave);

        // Get all the leaveList where physician does not contain DEFAULT_PHYSICIAN
        defaultLeaveShouldNotBeFound("physician.doesNotContain=" + DEFAULT_PHYSICIAN);

        // Get all the leaveList where physician does not contain UPDATED_PHYSICIAN
        defaultLeaveShouldBeFound("physician.doesNotContain=" + UPDATED_PHYSICIAN);
    }
    ...
    void putNewLeave() throws Exception {
        ...
        assertThat(testLeave.getPhysician()).isEqualTo(UPDATED_PHYSICIAN);
    }
